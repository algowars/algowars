  ...
  return (
    ...
    !isClosed && (
      <div
        ...
        } bg-red-200 border rounded border-red-700 text-red-700 fixed left-1/2 -translate-x-1/2 gap-2 top-5 w-11/12 md:w-fit flex justify-between items-center z-50`}
      >
