...
const NavbarAvatarDropdown = () => {
  ...
  const { user } = useAuth0();
  return (
    <div className="drop-shadow text-black absolute top-[130%] right-0 border border-slate-300 rounded bg-white w-[95%] left-1/2 -translate-x-1/2 md:left-[unset] md:-translate-x-0 md:right-5 md:w-64 p-3 z-50 fade-in ease-in duration-200">
